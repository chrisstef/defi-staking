    ...
    return (
      <div id="content" className="mt-5">
        <button
                ...
                className="btn btn-outline-light btn-md btn-block btn-white-space nowrap"
              >
                Claim USDT
              </button>
              &nbsp;&nbsp;
        ...
        >
          <form
            ...
            className="mb-3"
          >
            <div style={{ borderSpacing: "0 1em", width:"100%", padding:"0 10px" }}>
              <span className="float-right" style={{ color: "white", margin: "8px", marginRight: "1px" }}>
                Balance:{" "}
              ...
              <div className="input-group mb-4 ml-0.6">
                ...
                <div className="input-group-open">
                  <div className="input-group-text ml-1" style={{ backgroundColor: "rgba(137, 145, 211, .7)", cursor: "pointer" }}>
